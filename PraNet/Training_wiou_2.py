...
def train(train_loader, model, optimizer, epoch, save_path, writer):
    ...
    try:
        for i, (images, gts) in enumerate(train_loader, start=1):
            ...
            loss_init = wiou_loss(preds[0], gts) + wiou_loss(preds[1], gts) + wiou_loss(preds[2], gts)
            loss_final = wiou_loss(preds[3], gts)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_path', type=str,
                        default='./snapshot/1020_PraNet_wiou_2/', help='the path to save model and log')
