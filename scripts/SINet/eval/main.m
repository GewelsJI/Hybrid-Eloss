...
Models = {'SINet_bei', 'SINet_wce', 'SINet_e', 'SINet_wiou'};   % You can add other model like this format: Models = {'2019-ICCV-EGNet','2019-CVPR-CPD'};
modelNum = length(Models);

% ---- 2. Ground-truth Datasets Setting ----
DataPath = '../../../data/COS/TestDataset/';
Datasets = {'CAMO', 'COD10K', 'CHAMELEON'};  % You may also need other datasets, such as Datasets = {'CAMO','CPD1K'};
