...
Models = {'SCRN_bei', 'SCRN_wce', 'SCRN_wiou', 'SCRN_e'};   % You can add other model like this format: Models = {'2019-ICCV-EGNet','2019-CVPR-CPD'};
modelNum = length(Models);

% ---- 2. Ground-truth Datasets Setting ----
DataPath = '../../../data/SOD/TestDataset/GT/';
Datasets = {'DUT-OMRON', 'DUTS-test','HKU-IS'};
